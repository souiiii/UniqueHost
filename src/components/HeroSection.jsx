    ...
    <div className={styles.parent}>
      <div className={styles.mainContainer}>
        <h1 className={styles.heading}>
          ...
          <span className={styles.primaryHighlightedText}>Robust </span>Hosting
          for your next{" "}
        ...
        <p className={styles.description}>
          ...
          reliable and user-friendly platform. Trusted by a vibrant community of
          thousands.
        </p>
        <div className={styles.buttonDiv}>
          ...
          <div className={styles.discordDiv}>
            <svg className={styles.discordSvg}
